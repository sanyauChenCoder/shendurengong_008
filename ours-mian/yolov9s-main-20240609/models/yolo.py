...
class BaseModel(nn.Module):
    ...
    def _forward_once(self, x, profile=False, visualize=False):
        ...
        # if 'DCNv4' in str(m) or 'DCNv3' in str(m) or 'DCNv2' in str(m):
        #     self.cuda()
        #     x = x.cuda()
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        # ----------------------------------------------------------
                   ...
                   FocalModulation, ScConv, EfficientAttention
                   }:
            c1 = ch[f]
            c2 = ch[f]
            args = [c1, *args]

        elif m in {AIFI, CARAFE, DySample, HWD, HWD_ADown, SPD_ADown, Conformer, GhostConformer}:
            c1 = ch[f]
            c2 = ch[f]
            args = [c1, *args]
        elif m in {SPDConv, HWD_ADown}:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, *args]
        ...
        #     c2 = args[0]
            ...
            args = [c1]
                   ...
                   C3_DCNv3, RepNCSPELAN4DCNv3, RepNCSPELAN4_KAN}:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, *args]
